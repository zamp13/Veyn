...
|--numpy_seed|False|Option to initialize manually the seed of numpy. If you used one option to initialize seed the other are used by default at 0. By default, it is not used.|
|--tensorflow_seed|False|Option to initialize manually the seed of tensorflow. If you used one option to initialize seed the other are used by default at 0. By default, it is not used.|
|--random_seed|False|Option to initialize manually the seed of random library. If you used one option to initialize seed the other are used by default at 0. By default, it is not used.|
