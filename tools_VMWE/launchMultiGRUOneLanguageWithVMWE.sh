...
./parsemeCuptToDimsumWithVMWE.py ${OPT_CUPT} ${DATA}${LANG}${TRAIN}${CUPT} > ${DATA}${LANG}${TRAIN}${DIMSUM}
echo ${DATA}${LANG}${DEV}${CUPT}
./parsemeCuptToDimsumWithVMWE.py ${OPT_CUPT} ${DATA}${LANG}${DEV}${CUPT} ${OPT_TEST_BIS} > ${DATA}${LANG}${DEV}${DIMSUM}
...
./RNNMultiGRUWithVMWE.py ${ARGUMENTS}  > ${DATA}${LANG}${PREDICT}${DEV}${PRED}
echo "End train"
...
./addPredictToDimsumWithVMWE.py ${OPT_DIMSUM} ${DATA}${LANG}${DEV}${DIMSUM} ${OPT_TAG} ${DATA}${LANG}${PREDICT}${DEV}${PRED} > ${DATA}${LANG}${PREDICT}${DEV}${DIMSUM}
